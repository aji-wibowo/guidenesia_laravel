 						...
 						<div class="col-md-6">
 							...
 							<div class="box">
 								...
 								<div class="box-body">
 									...
 									<form action="{{url('admin/kota/edit/proses')}}/{{$kota->id_kota}}" method="post" enctype="multipart/form-data">
 										...
 										<div class="form-group">
 											...
 											<input type="text" name="nama_kota" class="form-control" id="nama_kota" value="{{$kota->nama_kota}}">
 										...
 										<div class="form-group">
 											...
 											<select class="form-control" name="provinsi">
 												...
 												<option {{$kota->id_provinsi == $p->id_provinsi ? 'selected' : ''}} value="{{$p->id_provinsi}}">{{$p->nama_provinsi}}</option>
 										...
 										<div class="form-group">
 											...
 											<input type="file" id="foto_kota" name="foto_kota">

 											<div>

 												<img src="{{url('images/kota').'/'.$kota->foto_kota}}" width="50%">
 										...
 										<div class="form-group">
 											...
 											<select class="form-control" id="status_kota" name="status_kota">
 												...
 												<option {{$kota->status_kota == '1' ? 'selected' : ''}} value="1">Aktif</option>

 												<option {{$kota->status_kota == '0' ? 'selected' : ''}} value="0">Tidak Aktif</option>
