...
<section class="content">
        ...
        <div class="col-md-3">
            ...
            <div class="box box-primary">
                <div class="box-body box-profile">
                    <a id="changePict" href="#" data-toggle="modal" data-target="#modal-default"><img class="profile-user-img img-responsive img-circle img-user-related" src="{{url('images/'.Auth::user()->photo_profile)}}" alt="User profile picture"></a>
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <div class="modal-body">
                                    <form id="formFotoProfil" action="{{url('upload')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" id="bSimpanFoto" class="btn btn-sm btn-primary">Simpan</button>
                                </div>
                            </div>
                            <!-- /.modal-content -->
                        </div>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $('form#formFotoProfil').on('submit', function(e){
                e.preventDefault();
                
                var formdata = new FormData();

                formdata.append('foto', $('input[name="foto_profil"]')[0].files[0]); 

                console.log(formdata);

                $.ajax({
                    url: '{{url('ajax/upload/photo/profile')}}',
                    data: formdata,
                    type: 'POST',
                    contentType: false, 
                    processData: false,
                    success : function(r){
                        ...
                        swal(r.title, r.text, r.icon);
                        if (r.icon == 'success') {
                            $('img.img-user-related').attr('src', '{{url('images')}}' + '/' + r.photoname);
            ...
            $('#bSimpanFoto').click(function(e){
                e.preventDefault();
                $('#formFotoProfil').submit();
            })
